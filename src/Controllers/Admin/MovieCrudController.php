...
class MovieCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setUpdateView('vsmov::movies.edit',);
    }
    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->addFilter([
            ...
            if ($field === 'language') {
                ...
                $this->crud->query->where($field, '')->orWhere($field, NULL)->orWhere($field, 'like', '%img.vsmov%')->orWhere($field, 'like', '%img.hiephanhthienha%');
            }
        });
        ...
        CRUD::addColumn([
            ...
            'label' => 'Thông tin',
            'type' => 'view',
            'view' => 'vsmov::movies.columns.column_movie_info',
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField([
            'name' => 'episodes',
            'type' => 'view',
            'view' => 'vsmov::movies.inc.episode',
            'tab' => 'Danh sách tập phim'
        ],);

        CRUD::addField(['name' => 'update_handler', 'label' => 'Trình cập nhật', 'type' => 'select_from_array', 'options' => collect(config('vsmov.updaters', []))->pluck('name', 'handler')->toArray(), 'tab' => 'Cập nhật']);
