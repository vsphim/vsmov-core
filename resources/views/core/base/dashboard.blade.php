...
@php
    $widgets['before_content'] = [
        [
            ...
            'heading' => 'VsMovCMS - Tạo website xem phim miễn phí vĩnh viễn',
            'content' =>
                '
                Phiên bản: <span class="text-danger text-break">' .
                config('vsmov.version') .
                '</span><br/>
                Trang chủ: <a href="https://vsmov.com">VsMovCMS.Com</a><br/>
                Dữ liệu phim miễn phí: <a href="https://vsmov.com">VsMov.COM</a>
            ',
